...
export const createDailyMetricSchema = registry.register('CreateDailyMetricRequest', z.object({
    serviceId: z
...
export const updateDailyMetricSchema = registry.register('UpdateDailyMetricRequest', createDailyMetricSchema
    .partial()
    .refine((data) => Object.keys(data).length > 0, {
    message: 'Pelo menos um campo deve ser fornecido para atualização.',
}));
export const dailyMetricResponseSchema = registry.register('DailyMetricResponse', z.object({
    id: z.string().uuid(),
...
//# sourceMappingURL=daily-metric.schemas.js.map