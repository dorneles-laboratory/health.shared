...
import { createMaintenanceSchema, updateMaintenanceSchema, maintenanceResponseSchema, maintenancePublicResponseSchema, maintenanceIdSchema } from './maintenance.schemas';
...
export type MaintenancePublicResponseDTO = z.infer<typeof maintenancePublicResponseSchema>;
export type MaintenanceIdDTO = z.infer<typeof maintenanceIdSchema>;
export type PaginatedMaintenancesDTO = PaginatedResultDTO<MaintenanceResponseDTO>;
