...
import { registry, z, createTaskSchema, updateTaskSchema, taskIdSchema, taskResponseSchema, rfc7807ErrorSchema, createPaginatedResponseSchema, pendingTimeResponseSchema, toggleTimerResponseSchema, } from '@lib/shared';
import { TaskController } from './IncidentUpdate.controller.js';
...
const taskPaginatedResponseSchema = createPaginatedResponseSchema(taskResponseSchema, 'TaskPaginatedResponse');
registry.registerPath({
    method: 'get',
    path: '/tasks',
...
//# sourceMappingURL=IncidentUpdate.routes.js.map