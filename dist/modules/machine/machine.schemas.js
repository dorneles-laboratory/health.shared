...
export const createMachineSchema = registry.register('CreateMachineRequest', z.object({
    name: z
        .string({
...
export const updateMachineSchema = registry.register('UpdateMachineRequest', createMachineSchema.partial().refine((data) => Object.keys(data).length > 0, {
    message: 'Pelo menos um campo deve ser fornecido para atualização.',
}));
// Schema de Resposta
export const machineResponseSchema = registry.register('MachineResponse', z.object({
    id: z.string().uuid(),
    name: z.string(),
    slug: z.string(),
...
//# sourceMappingURL=machine.schemas.js.map